...
export const MetodoPago = () => {
  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-sm relative">
      <h1 className="text-2xl font-bold text-gray-800 mb-3 text-center">Elige tu método de pago</h1>
      <p className="text-gray-600 mb-6 text-center">Selecciona un método de pago para continuar con la matrícula.</p>
      
      <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mb-6 rounded">
        <p className="text-sm text-blue-700 text-center">
          <span className="font-semibold">Importante:</span> Recuerda activar tu tarjeta para compras en línea antes de realizar el pago.
        </p>
      </div>
          ...
          <div key={metodo.id}>
            ...
            {metodoSeleccionado === 1 && metodo.id === 1 && (
              <div className="p-4 bg-gray-50 border border-t-0 rounded-b-lg space-y-3">
                <h3 className="text-lg font-semibold text-gray-800">Tarjetas de Crédito y Débito (Visa, MasterCard)</h3>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">MM/AA</label>
                    <input
                      type="text"
                      name="vencimiento"
                ...
                <p className="text-xs text-gray-500 text-center mt-2">
                  Cobraremos un monto mínimo para validar tu tarjeta. Este será devuelto de inmediato.
                </p>
              </div>
            )}
            ...
            {metodoSeleccionado === 2 && metodo.id === 2 && (
              <div className="p-4 bg-gray-50 border border-t-0 rounded-b-lg space-y-3">
                <div className="flex flex-col items-center mb-4">
                  <img src="/Carl-Sagan-log.png" alt="Carl Sagan" className="h-12 mb-2" />
                  <h3 className="text-lg font-semibold text-gray-800">Pago con Yape</h3>
                </div>
                
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Ingresa tu número de Yape</label>
                  <input
                    type="text"
                    name="telefono"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Ingresar Código de verificación</label>
                  <input
                    type="text"
                    name="codigo"
      ...
      {mostrarConfirmacion && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg max-w-sm mx-auto text-center">
            <h3 className="text-xl font-bold mb-4">¿Estás seguro de realizar el pago?</h3>
            <p className="mb-6">Se cobrará S/30.00 a tu {metodoSeleccionado === 1 ? 'tarjeta' : 'cuenta Yape'}</p>
